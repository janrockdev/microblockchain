...
const Difference = 20 // Possbile TODO: Change this constant to a dynamic algorithim
...
func NewProofOfWork(b *Block) *ProofOfWork {
	target := big.NewInt(1)
	target.Lsh(target, uint(256-Difference)) //256 is number of bytes in hash (SHA256), Lsh is "left shift"
